...
function Playlists() {
    const { currentUser
        ...
        deletePlaylistOpen,
        setConfirmedPlaylistDelete } = useAuth()
            ...
            <div className="body">
                ...
                <Dialog open={deletePlaylistOpen} keepMounted >
                    <div className="header">
                        ...
                        <Close className="close_icon" onClick={() => setDeletePlaylistOpen(false)} />
                    </div>
                    <DialogContent>
                        ...
                        <div className="delete-choices">
                            ...
                            <Button onClick={() => setDeletePlaylistOpen(false)} variant="outline-secondary">Cancel</Button>
                        </div>
