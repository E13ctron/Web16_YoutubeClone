...
const PreviewChannel = () => {
  ...
  const { videos, subscriptions, subscribeChannel, unsubscribeChannel } =
    useAuth();
            ...
            <div className="channel_detailsWrap">
              <div className="channel_avatarWrap">
                ...
                <div className="videothumb__channel">
                  ...
                  <p id="subId" className="videothumb__text watch__subCount">
              ...
              {subscribeBtnState ? (
                <Button
                  ...
                  className="watch__subBtn_subbed channel_subBtn"
                  color="primary"
                  variant="contained"
                >
                  {subscribe}
                ...
                <Button
                  ...
                  className="watch__subBtn channel_subBtn"
                  color="primary"
                  variant="contained"
                >
                  {subscribe}
