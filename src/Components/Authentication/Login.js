                ...
                <Card className="card_parent">
                    ...
                    <div className="youtubelogo">
                        ...
                        <Form className="form-body" onSubmit={ handleSubmit }>
                            ...
                            <div> <a href="./signup" style={{color: "rgb(201 29 32)", textDecoration: "none"}}>Sign Up</a></div>
                            <div style={{color: "white"}}>Forgot Password ? </div>
                            <div> <a href="./forgotpassword" style={{color: "rgb(201 29 32)", textDecoration: "none"}}>Reset Password</a></div>
                        </Form>
                        <GoogleSignIn/>
                    </Card.Body>
                </Card>
